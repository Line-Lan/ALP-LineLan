...
//$lang['stepone_description'] = 'edit the _config.php file located in the / directory of ALP.  edit the variables to describe your event party.';
...
$lang['steptwo_varone'] = 'event name';
...
$lang['steptwo_varten_error'] = "the end date of your event must be after the starting date.";
...
$lang["stepthree_next_choice1"] = "move on to step four - Full Version - creating the mysql table structure";
$lang["stepthree_next_choice2"] = "move on to step four - ALP in tournament mode only - creating the mysql table structure";
$lang["stepthree_next_choice3"] = "move on to step four - ALP in sports tournament mode only - creating the mysql table structure";
...
$lang["stepfour_next"] = "move on to step five - register the super admin account";
