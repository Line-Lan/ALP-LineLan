...
$lang = array(
	...
	"prizes_step2" => "time: allow sufficient time for users to register for prizes (ideally you'd wait until the end of the event)",
    ...
    "admin_news" => array(
		"plural" => "news",
		"singular" => "news item",
		"notes_add" => "news postings are displayed on the portal page to ALP.  it's commonly used for announcements.  the announcement text area will display the following html tags: &lt;a&gt; &lt;b&gt; &lt;i&gt; &lt;u&gt; &lt;font&gt; &lt;img&gt; &lt;strong&gt;",
    ...
    "admin_prize_control" => array(
        ...
        "note_absentees" => "When you redraw a prize, the interactive prize drawing script assumes the person has left the event and makes them ineligible for any future prizes.  If you want to reinstate a users eligibility for prizes, do so below:",
        ...
        "error_disabled" => "the administrator has disabled prizes for this event."
		),
    "admin_prize_draw" => array(
        ...
        "error_prizes_disabled" => "the administrator has disabled prizes for this event.",
    	),
    ...
    "login" => array(
    	...
    	"security_long" => "for maximum security, enable javascript. &nbsp;do not be alarmed, your password will autoencrypt when you click the register button.",
...
//$lang["install"]['stepone_description'] = 'edit the _config.php file located in the / directory of ALP.  edit the variables to describe your event.';
