...
<?php
disp_gamingrig('amd', "comp_proc='AMD'", "comp_proc!=''", 'amd.gif', 'http://www.amd.com', '#212121', 56);
disp_gamingrig('intel', "comp_proc='INTEL'", "comp_proc!=''", 'intel.gif', 'http://www.intel.com', '#212121', 56);
disp_gamingrig('ati', "comp_gfx_gpu='ATI'", "comp_gfx_gpu!=''", 'ati.gif', 'http://www.ati.com', '#212121', 23);
disp_gamingrig('nvidia', "comp_gfx_gpu='Nvidia'", "comp_gfx_gpu!=''", 'nvidia.gif', 'http://www.nvidia.com', '#212121', 28);
spacer(1,4,1); ?>
