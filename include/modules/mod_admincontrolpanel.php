...
$menu[] = array('admin_add_dummy_users.php','dummy users',3);
$menu[] = array('','',2);
...
if(!ALP_TOURNAMENT_MODE) {
	...
	//echo $toggle['satellite'];
	//if ($toggle['satellite'])
	$menu[] = array('admin_satellite.php','satellites',2);
...
<form name="menuSide">
<select name="go" style="width: <?php echo $this->get_inner_width(); ?>; font: 10px consolas" onChange="goToSide()">
<?php
foreach($menu as $val) { 
...
<tr><td width="50%"><nobr><?php get_arrow(); ?>&nbsp;<a href="admin_index.php" class="menu"><b>more settings</b></a><nobr><td width="50%"><?php get_arrow(); ?>&nbsp;<a href="phpinfo.php" class="menu"><b>phpinfo</b></a></td></tr>
<tr><td width="50%"><nobr><?php get_arrow(); ?>&nbsp;<a href="http://mail.line-lan.net/" class="menu"><b>E-Mail</b></a>
<?php 
if(!ALP_TOURNAMENT_MODE) { ?>
