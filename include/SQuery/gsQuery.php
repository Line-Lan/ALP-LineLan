 ...
 * @version $Id: gsQuery.php,v 1.4 2006/07/19 21:33:15 synth_spring Exp $
 *
...
class gsQuery
{
  ...
  function createInstance($protocol, $address, $port) {
   global $libpath;
    ...
    case("unreal"):
      include_once($libpath."unreal.php");
      return new unreal($address, $port);
    case("savage"):
      include_once($libpath."savage.php");
      return new savage($address, $port);
    case("q2a"):
      include_once($libpath."q2a.php");
      return new q2a($address, $port);
    case("q3a"):
       include_once($libpath."q3a.php");
       return new q3a($address, $port);
    case("ut2004"):
      include_once($libpath."ut2004.php");
      return new ut2004($address, $port);
    case("doom3"):
      include_once($libpath."doom3.php");
      return new doom3($address, $port);
    case("halo"):
      include_once($libpath."halo.php");
      return new halo($address, $port);
    case("ravenshield"):
...
function docvars($gameserver)
{
   ...
   * 
   */
  function _sendCommand($address, $port, $command, $timeout=100000)
  {
