...
$img = imagecreate(15,$control['room_height'])
...
for($i = 0,$j = 0; $i < $control['room_height']; $i+=$corr,$j++) {
	imageline($img,0,$i,15,$i,$imageColor['gridcolor']);
	imagestring($img,1,3,$i+($corr/2)-6,$j,$imageColor['text']);
}
